...
![alt text](<../image/5주차/문제2 풀이화면 1.png>)


**⚪2. 측정값 case 활성화를 위한 계산식 추가**

![alt text](<../image/5주차/문제2 풀이화면 2.png>)

```
❗sum([각 지표])를 한 이유

 카테고리의 전체 수익을 계산하거나, 그 값을 전체 평균과 비교하려면, 전화기 카테고리의 모든 수익을 합한 값이 필요
...
❓왜 avg는 안되징..
❗AVG 혹은 WINDOW_AVG와 같이 집계함수 뒤에 오는 필드는 숫자필드여야함 

=> 측정값 선택이 아닌 측정값 선택 계산식 활용 

**⚪4. 색깔 구분을 위한 비교 계산식 추가**

![alt text](<../image/5주차/문제2 풀이화면 4.png>)
...
![alt text](<../image/5주차/문제2 결과_매출.png>) 
